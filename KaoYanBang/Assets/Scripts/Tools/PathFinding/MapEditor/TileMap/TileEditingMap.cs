using liulaoc.DstarPathFinding.Editor;
using System.Collections;
using System.Collections.Generic;
using UnityEngine;
namespace liulaoc.DstarPathFinding.Editor.TileMap
{
    public class TileEditingMap : MonoBehaviour
    {
        ...
        protected void EditOperationUpdate()
        {
            //Todo:用户操作
        }
        ...
        protected void SetStartEndPoint()
        {
        ...
        #region 回调
        protected void InitMap(Transform start, Transform end)
        {
